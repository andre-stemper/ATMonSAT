...
#define ENABLE_ATMONSAT_OTHER_TASK
#define ATMONSAT_OTHER_TASK_STACK 1000
#define ATMONSAT_ANOMALY_DETECTION_TASK_STACK 4000

#ifdef POWER_MEASUREMENT
#undef ENABLE_ATMONSAT_OTHER_TASK
#endif
